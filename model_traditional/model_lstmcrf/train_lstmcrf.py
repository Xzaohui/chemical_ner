    ...
    for i in range(epoch):
        for j,(data,lab,mask) in enumerate(dataloader):
            ...
            if j%10==0:
                ...
                print("=================================================")
    torch.save(model.state_dict(), "C:/Users/83912/Desktop/project/chemical_ner/model/lstmcrf_"+datetime.datetime.now().strftime('%m-%d,%H_%M_%S')+".pkl")

# train(model,epoch,data_manage.train_dataloader)